				...
				<div className="sidebar-user-block">
					...
					>
						...
						>
							...
							{
								!this.props.shouldblack &&
									<div className="user-info">
										<span className="user-name ml-4" style={{color: '#fff'}}>Lucile Beck</span>
										<i className="zmdi zmdi-chevron-down dropdown-icon mx-4" style={{color: '#fff'}}></i>
									</div>
							}
