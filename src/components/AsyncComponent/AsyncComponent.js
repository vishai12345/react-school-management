...
// Basic Table
const AsyncDataTableComponentPoll = Loadable({
	loader: () => import("Routes/tables/data-table/index_poll"),
	loading: () => <RctPageLoader />,
});

// Basic Table
const AsyncDataTableComponentAssessment = Loadable({
	loader: () => import("Routes/tables/data-table/index_assessment"),
	loading: () => <RctPageLoader />,
});
...
export {
	...
	AsyncDataTableComponentAssessment
};
