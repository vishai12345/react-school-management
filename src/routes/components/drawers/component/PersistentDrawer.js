...
class PersistentDrawer extends React.Component {
    ...
    state = {
        ...
        questionContainerInColumns: '100',
    ...
    handleSubmit = (type) => {
        let { question,options, questionsArray, optionType, questionContainerInColumns, questionContainerHeight } = this.state;
    ...
    setQuestionLayout(type, value){
        this.setState({ [type]: value }, () => this.props.setQuestionLayout(type, value))
    }
            ...
            <div className='drawerInnerAfterDividerCustomClass'>
                ...
                { this.props.drawerType === 'addQuestionType' && <TabContent activeTab={this.state.activeTab}>
                    <TabPane tabId="1">
                            <div className="whole_options">
                                <div className="option_left">
                                    ...
                                    <div className="typ1">                                                
                                        <a id="Popover3" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                            ...
                            {/* <!-- right side first type starts TEXT --> */}
                                <div className="option_right">
                                    <h3>Text</h3>
                                    <div className="typ1">                                                
                                        <a id="Popover4" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                                    ...
                                    <div className="typ1">                                                
                                        <a id="Popover6" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                                    ...
                                    <div className="typ1">                                                
                                        <a id="Popover7" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                            ...
                            {/* <!-- second row of left & right starts --> */}
                                <div className="option_left">
                                    ...
                                    <div className="typ1">                                                
                                        <a id="Popover8" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                                    ...
                                    <div className="typ1">                                                
                                        <a id="Popover9" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                                    ...
                                    <div className="typ1">                                                
                                        <a id="Popover10" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                                    ...
                                    <div className="typ1">                                                
                                        <a id="Popover11" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                                    ...
                                    <div className="typ1">                                                
                                        <a id="Popover12" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                                    ...
                                    <div className="typ1">                                                
                                        <a id="Popover13" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                            ...
                            {/* <!-- right side second type starts TEXT --> */}
                                ...
                                <div className="option_right">
                                    <h3>Image Chooser</h3>
                                    <div className="typ1">                                                
                                        <a id="Popover14" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                                            <img src={require('Assets/images/select_one.png')} className="option_img" />   
                                    ...
                                    <div className="typ1">                                                
                                        <a id="Popover15" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                                    ...
                                    <div className="typ1">                                                
                                        <a id="Popover16" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                                    ...
                                    <h3>Basic Matrix</h3>
                                    <div className="typ1">                                                
                                        <a id="Popover17" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                                    ...
                                    <div className="typ1">                                                
                                        <a id="Popover18" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                                    ...
                                    <div className="typ1">                                                
                                        <a id="Popover19" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                            ...
                            {/* <!-- third row of left & right starts --> */}
                                <div className="option_left">
                                    <h3>Ordering</h3>
                                    <div className="typ1">                                                
                                        <a id="Popover20" onMouseLeave={() => this.togglePopover('')} href="javascript:void(0);" className="btn btn-primary btn-block mt-1 popper">
                    ...
                    { this.props.drawerType === 'addIntroType' && <TabContent activeTab={this.state.activeTab}>
                                ...
                                <div className={`d-flex justify-content-start ml-3`}>
                                    <ul className="themes">
                                        {this.state.colors.map((color, index) => {
                                                return(
                                                    <li key={index} onClick={() => this.setColor('simple', color.colorCode)} data-background={`${color.class}`} className={`${color.class}`}><a href="javascript:void(0);" data-class={`is ${color.class}`}>{ color.class }</a></li>
                                                )
                                        })}
                                    </ul>
                                </div>
                            ...
                            <div className="col-md-6">
                                ...
                                <div className={`d-flex justify-content-start ml-3`}>
                                    <ul className="themes">
                                        {this.state.colors.map((color, index) => {
                                                return(
                                                    <li key={index} onClick={() => this.setColor('boxed', color.colorCode)} data-background={`${color.class}`} className={`${color.class}`}><a href="javascript:void(0);" data-class={`is ${color.class}`}>{ color.class }</a></li>
                                                )
                                        })}
                                    </ul>
                                </div>
                            ...
                            <div className="col-md-6">
                                ...
                                <div className={`d-flex justify-content-start ml-3`}>
                                    <ul className="themes">
                                        {this.state.colors.map((color, index) => {
                                                return(
                                                    <li key={index} onClick={() => this.setColor('inline', color.colorCode)} data-background={`${color.class}`} className={`${color.class}`}><a href="javascript:void(0);" data-class={`is ${color.class}`}>{ color.class }</a></li>
                                                )
                                        })}
                                    </ul>
                                </div>
                                    ...
                                    <ul className="themes">
                                        {
                                            this.state.fontSizes.map((fontSize, index) => {
                                                return(
                                                    <li key={index} onClick={() => this.setFontSize('questionFontsize', fontSize)} className="light"><a className='label-fontsize' href="javascript:void(0);" data-class="is light">{ fontSize }</a></li>
                                                )
                                            })
                                        }
                                    </ul>
                        ...
                        <TabPane tabId="1">
                            {
                                this.props.page === 'poll' && <div className='form-group mr-5'>
                                    <FormControl fullWidth>
                                        <InputLabel htmlFor="option-simple"> Select Number Of Columns</InputLabel>
                                        <Select onChange={(e) => this.setQuestionLayout( 'questionContainerInColumns', e.target.value )} value={this.state.questionContainerInColumns} inputProps={{ name: 'questionInColumns', id: 'questionInColumnsId' }}>
                                            <MenuItem value={`${ 100 / 1}`}><em>1</em></MenuItem>
                                            <MenuItem value={`${ 100 / 2}`}><em>2</em></MenuItem>
                                            <MenuItem value={`${ 100 / 3}`}><em>3</em></MenuItem>
                                            <MenuItem value={`${ 100 / 4}`}><em>4</em></MenuItem>
                                            <MenuItem value={`${ 100 / 5}`}><em>5</em></MenuItem>
                                            <MenuItem value={`${ 100 / 6}`}><em>6</em></MenuItem>
                                            <MenuItem value={`${ 100 / 7}`}><em>7</em></MenuItem>
                                            <MenuItem value={`${ 100 / 8}`}><em>8</em></MenuItem>
                                        </Select>
                                    </FormControl>
                                </div>
                            }
                            {
                                this.props.page === 'poll' && <TextField className='mr-5' id="with-placeholder" fullWidth label={`Height in Pixels`}
                                    value={this.state.questionContainerHeight} onChange={(e) => this.setQuestionLayout('questionContainerHeight', e.target.value)}
